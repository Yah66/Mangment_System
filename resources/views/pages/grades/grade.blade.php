                        ...
                        <tbody>
                            ...
                            @foreach ($Grades as $Grade)
                                <tr>
                                    ...
                                    <td>{{ $Grade->name }}</td>
                                    <td>{{ $Grade->note }}</td>
                                    <TD> <img src="{{ asset('storage/' . $Grade->image) }}" alt=""
                                                ...
                                                <form action="{{ route('Grades.update', 'test') }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            ...
                                                            :</label>
                                                        <textarea class="form-control" name="note" id="exampleFormControlTextarea1" rows="3">{{ $Grade->Notes }}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleFormControlTextarea1">{{ trans('Grades_trans.image') }}
                                                            :</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('Grades.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">{{ trans('Grades_trans.image') }}
                                :</label>
                            <input class="form-control" type="file" name="image"
                                id="exampleFormControlTextarea1" rows="3">
                        </div>
